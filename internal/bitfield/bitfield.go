// Thank You For Jose Sitanggang
// See origin repo :
// https://github.com/josestg/bitfield/blob/main/bitfield.go
...
// safeShiftLeft shifts left 1 by
// n bits, returning 0 if n >= 64.
...
// Difference returns a new field that all bits
// that are set in x, but not set in y (x / y).
// Note that x/y != x/y.
